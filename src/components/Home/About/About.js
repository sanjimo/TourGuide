...
import img from '../../../images/shimla2.jpg';

const About = () => {
    return (
        <div className="w-75 mx-auto mt-5 mb-5">
            <h4>About <span className="text-warning">Tour</span><span className="text-success">Guide</span></h4><hr className="w-25 bg-success mx-auto"/>
                ...
                <div className="row g-0">
                    ...
                    <div className="col-md-6 col-sm-12">
                        <div className="card-body text-start">
                            <h5 className="card-title">Discover <span className="text-warning">Tour</span><span className="text-success">Guide</span></h5>
